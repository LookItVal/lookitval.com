import{_ as l}from"./DKk1dnT1.js";import{_ as m,o as i,p as d,w as f,c,a as t}from"./FF2YmK31.js";const h=""+new URL("QVC.CMajLVUU.svg",import.meta.url).href,p={name:"Logo",data(){return{isAnimating:!1}},methods:{shimmer(){if(this.isAnimating)return;this.isAnimating=!0,this.$refs.logoSvg.querySelectorAll("animateMotion").forEach(a=>{a.beginElement()}),setTimeout(()=>{this.isAnimating=!1},1e3)}}};function g(o,e,a,u,_,n){const r=l;return i(),d(r,{to:"/",class:"logo"},{default:f(()=>[(i(),c("svg",{ref:"logoSvg",height:"100%",width:"100%",viewBox:"0 0 20 10",onMouseover:e[0]||(e[0]=(...s)=>n.shimmer&&n.shimmer(...s))},e[1]||(e[1]=[t("defs",null,[t("mask",{id:"logo-mask",height:"100%",width:"100%"},[t("image",{href:h,height:"100%",width:"100%"})]),t("radialGradient",{id:"radial-gradient",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},[t("stop",{offset:"0%",style:{"stop-color":"var(--red)","stop-opacity":"1"}}),t("stop",{offset:"100%",style:{"stop-color":"var(--red)","stop-opacity":"0"}})])],-1),t("g",{mask:"url(#logo-mask)"},[t("rect",{width:"100%",height:"100%",fill:"var(--lavender)"}),t("path",{id:"animated-path-1",d:`M 9.7,7.7
                                               L 7.4,2 
