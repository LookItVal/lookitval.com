<template>
  <div ref="hexContainer" class="hex-container">
    <svg viewBox="-5 -5 110 110" class="hex-svg">
      ...
      <g class="image-mask" mask="url(#hexMask)">
        <image
          ref="backgroundImage"
          class="hex-image background-image"
          href="/images/SoundGirlBackground.jpg"
          width="110%"
          height="110%"
          x="-2.5"
        />
        <image
          ref="foregroundImage"
          class="hex-image foreground-image"
          href="/images/SoundGirlRoto.png"
          width="115%"
          height="115%"
          x="1.5"
        />
