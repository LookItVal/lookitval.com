import{_ as l}from"./DPAIJUUq.js";import{_ as d,o as n,f,w as c,c as m,a as t}from"./w2rP2WR4.js";const p=""+new URL("QVC.CMajLVUU.svg",import.meta.url).href,g={name:"Logo",data(){return{isAnimating:!1}},methods:{shimmer(){if(this.isAnimating)return;this.isAnimating=!0,this.$refs.logoSvg.querySelectorAll("animateMotion").forEach(e=>{e.beginElement()}),setTimeout(()=>{this.isAnimating=!1},1e3)}}};function h(a,o,e,u,_,i){const r=l;return n(),f(r,{to:"/",class:"logo"},{default:c(()=>[(n(),m("svg",{ref:"logoSvg",height:"100%",width:"100%",viewBox:"0 0 20 10",onMouseover:o[0]||(o[0]=(...s)=>i.shimmer&&i.shimmer(...s))},o[1]||(o[1]=[t("defs",null,[t("mask",{id:"logo-mask",height:"100%",width:"100%"},[t("image",{href:p,height:"100%",width:"100%"})]),t("radialGradient",{id:"radial-gradient",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},[t("stop",{offset:"0%",style:{"stop-color":"var(--red)","stop-opacity":"1"}}),t("stop",{offset:"100%",style:{"stop-color":"var(--red)","stop-opacity":"0"}})]),t("radialGradient",{id:"logo-gradient",cx:"20%",cy:"0%",r:"150%",fx:"50%",fy:"50%"},[t("stop",{offset:"0%",style:{"stop-color":"var(--lavender)","stop-opacity":"1"}}),t("stop",{offset:"100%",style:{"stop-color":"var(--mauve)","stop-opacity":"1"}})])],-1),t("g",{mask:"url(#logo-mask)"},[t("rect",{width:"100%",height:"100%",fill:"url(#logo-gradient)"}),t("path",{id:"logo-path-1",d:`M 9.7,7.7
                                               L 7.4,2 
