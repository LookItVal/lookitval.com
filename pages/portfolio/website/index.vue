<template>
  <div class="website-portfolio">
    <div class="header">
      <ShimmeringText text="Website Portfolio" header-tag="h1" color="mgs" />
    </div>
...
const { data: allPagesRaw } = await useAsyncData('websitePortfolio', () => queryCollection('websitePortfolio').all());
